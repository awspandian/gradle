...
_Depends on_: `compileJava` (remove with `tasks.named('compileScala') { classpath = sourceSets.main.compileClasspath }`)
+
...
_Depends on_: `compileTestJava` (remove with `tasks.named('compileTestScala') { classpath = sourceSets.test.compileClasspath }`)
+
...
_Depends on_: `compile__SourceSet__Java` (remove with `tasks.named('compile__SourceSet__Scala') { classpath = sourceSets.__sourceSet__.compileClasspath }`)
+
