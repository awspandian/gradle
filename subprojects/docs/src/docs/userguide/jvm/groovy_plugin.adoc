...
_Depends on_: `compileJava` (remove with `tasks.named('compileGroovy') { classpath = sourceSets.main.compileClasspath }`)
+
...
_Depends on_: `compileTestJava` (remove with `tasks.named('compileTestGroovy') { classpath = sourceSets.test.compileClasspath }`)
+
...
_Depends on_: `compile__SourceSet__Java` (remove with `tasks.named('compile__SourceSet__Groovy') { classpath = sourceSets.__sourceSet__.compileClasspath }`)
+
